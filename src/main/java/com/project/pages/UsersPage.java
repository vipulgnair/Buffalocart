...
public class UsersPage extends PageUtility {
	...
	@FindBy(id = "email")
	WebElement email;
	@FindBys(@FindBy(xpath = "//ul[@id='select2-role-results']//li"))
	...
	@FindBys(@FindBy(xpath = "//ul[@id='select2-selected_contact_ids-t1-results']//li"))
	List<WebElement> selectContactOptions;
	@FindBy(id = "submit_user_button")
	WebElement save;
	@FindBys(@FindBy(xpath = "//table[@id='users_table']//tbody//td"))
	...
	public void clickUserview() {
		clickOnElement(viewUser);
	}
